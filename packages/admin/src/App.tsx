...
import { BillVerificationsPage } from './pages/BillVerificationsPage'
  ...
  return (
    <AdminLayout>
      <Routes>
        ...
        <Route path="/bill-verifications" element={authed ? <BillVerificationsPage /> : <Navigate to="/login" replace />} />
